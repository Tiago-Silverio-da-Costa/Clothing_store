    ...
    <Container>
        ...
        <Wrapper>
            ...
            <Top>
                ...
                <TopTexts>
                    <TopText>Bolsa de Compras(1)</TopText>
            ...
            <Bottom>
                <Info>
                    {/* <Product>
                        <ProductDetail>
                            ...
                            <Details>
                                <ProductName><b>Produto:</b> HAKURA T-SHIRT</ProductName>
                                <ProductId><b>ID:</b> 894038345</ProductId>
                                <ProductColor color="gray"/>
                                <ProductsSize><b>Tamanho:</b> M</ProductsSize>
                            </Details>
                        </ProductDetail>
                        <PriceDetail>
                    ...
                    <Product>
                        <ProductDetail>
                            <Image src={M6} />
                            <Details>
                                <ProductName><b>Produto:</b> Vestido Wine </ProductName>
                                <ProductId><b>ID:</b> 894038345</ProductId>
                                <ProductColor color="#4f071b"/>
                                <ProductsSize><b>Tamanho:</b> M</ProductsSize>
                            </Details>
                        </ProductDetail>
                        <PriceDetail>
                ...
                <Summary>
                    ...
                    <SummaryItem type="total">
                        ...
                        <SummaryItemPrice>R$ 31</SummaryItemPrice>
                    </SummaryItem>
